...
3. **Discover workflows** (`rules/discover-workflows.md`) — only after step 2 auth proof
   - **Grok Bot:** do not start here. Follow `rules/connect-grok-bot.md` (intro, then connect, then route from what they already told you).
...
- `rules/connect-grok-bot.md` — Grok Bot: intro as a marketing engineer teammate, then MCP connect
